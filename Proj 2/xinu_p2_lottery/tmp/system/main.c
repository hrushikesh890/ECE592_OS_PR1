...
int main() {
	...
	prA = create_user_process(burst_execution, 1024, "burst_execution", 3, 10, 500, 10);
	prB = create_user_process(burst_execution, 1024, "burst_execution", 3, 10, 500, 20);
	prC = create_user_process(burst_execution, 1024, "burst_execution", 3, 10, 500, 30);
